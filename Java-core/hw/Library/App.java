...
public class App {
    public static void main(String[] args) {
        ...
        // Line item: thông tin các sách trong một phiếu thuê (id, số lượng)
        ...
        Book fantasticBeasts = new Book("Fantastic Beasts and Where to Find Them", "2001", fantasticBeastsAuthors,
                "Bloomsbury", "128 pages");
        Book onWallStreet = new Book(
                "One Up On Wall Street: How To Use What You Already Know To Make Money In The Market", "April 3, 2000",
                onWallStreetAuthors, "Simon & Schuster", "304 pages");
        data.bookRepo.add(introductionToJava);
        data.bookRepo.add(fantasticBeasts);
        data.bookRepo.add(onWallStreet);

        LineItem trungrent1 = new LineItem(onWallStreet, 200, 20);
        LineItem trungrent2 = new LineItem(fantasticBeasts, 50, 40);
        LineItem trungrent3 = new LineItem(introductionToJava, 100, 60);
        ...
        RentalList rentaList1 = new RentalList(trung, LocalDateTime.now(),"doc sach mua dich" , list1);
